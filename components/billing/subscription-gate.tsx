...
export function SubscriptionGate({
  ...
  return (
    <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-[#e7e5e4] bg-[#fafaf9] p-6 sm:p-8">
      {/* Decorative Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#b8860b]/5 via-transparent to-transparent" />

      <div className="relative text-center">
        {/* Icon */}
        <div className="mx-auto flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl sm:rounded-2xl bg-[#1c1917] shadow-lg shadow-[#1c1917]/10">
          <Lock className="h-5 w-5 sm:h-6 sm:w-6 text-white" />
        </div>

        {/* Content */}
        <h3 className="mt-4 sm:mt-5 font-semibold text-lg sm:text-xl text-[#1c1917] tracking-tight">
          Premium Feature
        </h3>
        <p className="mt-2 text-xs sm:text-sm text-[#78716c] max-w-xs mx-auto">
        ...
        <div className="mt-5 sm:mt-6 flex flex-col items-center gap-3">
          <Button
            ...
            loading={isUpgrading}
            className={cn(
              "h-11 px-6 text-sm font-medium transition-all duration-200 group touch-target",
